...
- Use the theme editor to configure a shadcn/ui theme, including preset, headless base, and RTL and pointer options, for React frontends
- Or open it via:
...
- `--payments`: polar, stripe, autumn, dodo, creem, chargebee, commet, none
- `--addons`: turborepo, nx, vite-plus, pwa, tauri, electrobun, biome, lefthook, husky, starlight, fumadocs, ultracite, oxlint, eslint, mcp, opentui, wxt, skills, evlog, axiom, turnstile, none
