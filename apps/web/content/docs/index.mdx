...
```npm
npx @wundero/create-better-t-stack@latest builder
```
...
```npm
npx @wundero/create-better-t-stack@latest my-webapp \
...
```npm
npx @wundero/create-better-t-stack@latest my-api \
  --frontend tanstack-router \
  --backend convex \
  --auth clerk
```
...
```npm
npx @wundero/create-better-t-stack@latest my-native \
...
```npm
npx @wundero/create-better-t-stack@latest my-workspace \
  --frontend none \
  --backend none
```
...
- `--payments`: polar, none
- `--addons`: turborepo, nx, pwa, tauri, electrobun, biome, lefthook, husky, starlight, fumadocs, ultracite, oxc, mcp, opentui, wxt, skills, evlog, none
