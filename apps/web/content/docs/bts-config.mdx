...
// safe to delete
{
  ...
  "reproducibleCommand": "bunx @wundero/create-better-t-stack@latest create-json --input '{...}'",
...
- `packageScope` stores the scope used by generated workspace imports and package names
