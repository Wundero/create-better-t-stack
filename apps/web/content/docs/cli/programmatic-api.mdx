...
The programmatic API is exported from `@wundero/create-better-t-stack` and is designed for automation tools, internal generators, and scripted workflows.
...
```npm
npm i @wundero/create-better-t-stack
```

## Quick Start

```typescript
import { create } from "@wundero/create-better-t-stack";
...
- Supports `packageScope` for generated workspace imports and package names. It defaults to `@<projectName>`.
...
```typescript
import { createVirtual } from "@wundero/create-better-t-stack";
