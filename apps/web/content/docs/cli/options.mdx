...
Set the generated workspace package scope. By default, generated packages use `@<project-name>`, such as `@my-app/api`.

```bash
create-better-t-stack my-app --package-scope @wundero
```
